            ...
            <div class="container">
                <div class="col-left">
                    <div class="login-text">
                        ...
                        <a href="<%=context%>\pages1\StudentRegister.jsp" class="btn">Sign Up</a>
                    </div>
                </div>
                ...
                <div class="col-right">
                    <div class="login-form">
                        ...
                        <form action="">
                            <p>
                                <label>Student User Id <span>*</span></label>
                                <input type="text" placeholder="Username or Email" name="userid" required>
                            </p>
                            <p>
