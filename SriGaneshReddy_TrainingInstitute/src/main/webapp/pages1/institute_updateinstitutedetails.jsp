...
<nav>
         <ul>
      				...
      				<li><a class="active" href="institute_updateinstitutedetails.jsp">Modify Institute Details</a></li>
 ...
 <div class="center">
      <h1>Institutes Details</h1>
      <form name="Institute_Name" action="institute_home.do" method="post">
       
       
        <input type="submit" name="action" value="updateinstitute">
