...
<h3>Welcome ${requestScope.details.institute_Name }</h3>            <!-- <!--  check after portal id change to institute name--> -->
<h4>Please note your password for further use
${requestScope.details.password }</h4>

<span><a href="<%=context%>\pages1\InstituteLogin.jsp">Click here </a> to login</span>
