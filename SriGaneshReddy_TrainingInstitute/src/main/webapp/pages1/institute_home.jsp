...
<html>
 <head>
   ...
   <body>
      ...
      <div><h1> Institute Logged in Successfully  ${Name} Institute</h1></div>
   </body>
</html>
...
<div class="clearfix">
  <div class="column menu">
    <ul>
      <li><a href="<%=context%>\Institute\InstituteStudent.jsp"><h3>View Student details</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteUploadArticle.jsp"><h3>Upload Article</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteViewArticle.jsp"><h3>View Article</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteInsertFaculty.jsp"><h3>Insert Faculty Details</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteViewFaculty.jsp"><h3>View Faculty Details</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteUpdateInstitute.jsp"><h3>Update Institute Details</h3></a></li>
      <li><a href="<%=context%>\Institute\InstituteViewFeedbackStudents.jsp"><h3>View Feedback By Students</h3></a></li>
    </ul>
  </div>
